...
- **Burnout Force:** a "Take the Assessment" button (to the Burnout Force Check, burnoutforce.higherperformancegroup.com) next to "Talk It Through", in both the hero and the final call to action. It's outlined, so gold stays on the main button.
